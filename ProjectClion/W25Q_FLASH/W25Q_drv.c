...
#define W25Q_PAGE_PRM_QTY_TIMEOUT       (5U)
#define W25Q_ER_4K_QTY_TIMEOUT          (5U)
...
STD_RESULT W25Q_ReadData(const uint32_t adr,uint8_t* data, const uint32_t len)
{
    ...
    timeoutCnt = W25Q_Times.nNone.nQuantityTimeout;
